    ...
    return (
        <main className="h-full flex flex-col md:max-w-md mx-auto">
            <section className="flex flex-col h-full gap-2">
                ...
                <article className="py-4 px-4 font-mono text-xs h-[10vh] border-2 flex justify-around items-center flex-shrink-0">
                ...
                {/* Zone des 2 casiers */}
                <article className="flex flex-col gap-6 justify-center items-center text-white flex-1 py-4">
                    {renderLocker('left')}
                    {renderLocker('right')}
                </article>
            </section>
